...
--modified table and populated random data in missing columns
ALTER TABLE shipper
RENAME TO shippers; 
...
update products set unitsInStock = floor(random() * 80 + 1)::int;
	
update products set unitsOnOrder = floor(random() * 80 + 1)::int;
	
update products set reorderLevel = floor(random() * 80 + 1)::int;
